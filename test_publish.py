#!/usr/bin/env python3
"""
Публикация тестовой статьи без лишних проверок
"""
...
print("Попытка публикации тестовой статьи...")
print(f"Пользователь: {username}")
print(f"Сайт: {site_url}")

# Данные для тестовой статьи
test_article = {
...
try:
    ...
    if response.status_code == 201:
        ...
        if publish_response.status_code == 200:
            ...
            print(f"   Новая ссылка: {published_info['link']}")
        else:
